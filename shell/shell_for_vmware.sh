...
tmux send-keys -t ros_session:1.1 'sleep 7; source ~/group2_ws/devel/setup.bash; roslaunch scan_land scan_land.launch' C-m
tmux send-keys -t ros_session:1.2 'sleep 15; roslaunch scan_land scan_land_py.launch' C-m
# 整理第二个窗口布局
